    ...
    switch ( pConfig->Resolution )
    {
        case ISI_RES_SVGA30:
        {
            if((result = IsiRegDefaultsApply((IsiSensorHandle_t)pSP2518Ctx,SP2518_g_svga)) != RET_SUCCESS){
                TRACE( SP2518_ERROR, "%s: failed to set  ISI_RES_SVGA30 \n", __FUNCTION__ );
            }else{

                TRACE( SP2518_INFO, "%s: success to set  ISI_RES_SVGA30 \n", __FUNCTION__ );
            }
            break;
        }
        case ISI_RES_1600_1200:
        {
            if((result = IsiRegDefaultsApply((IsiSensorHandle_t)pSP2518Ctx,SP2518_g_1600x1200)) != RET_SUCCESS){
                TRACE( SP2518_ERROR, "%s: failed to set  ISI_RES_1600_1200 \n", __FUNCTION__ );
            }else{

                TRACE( SP2518_INFO, "%s: success to set  ISI_RES_1600_1200  \n", __FUNCTION__ );
            }
            break;
        }
        default:
...
)
{
    ...
    result = SP2518_IsiGetCapsIss( handle, &Caps);
