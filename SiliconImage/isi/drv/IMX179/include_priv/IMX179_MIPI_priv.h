...
#ifndef __IMX179_PRIV_H__
#define __IMX179_PRIV_H__
...
#define Sensor_CHIP_ID_HIGH_BYTE            (0x0002) // r - 
#define Sensor_CHIP_ID_LOW_BYTE          (0x0003) // r - 

#define Sensor_CHIP_ID_HIGH_BYTE_DEFAULT            (0x21) // r - 
#define Sensor_CHIP_ID_LOW_BYTE_DEFAULT          (0x79) // r - 
