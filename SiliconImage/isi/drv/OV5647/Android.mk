...
LOCAL_SRC_FILES:=\
	source/OV5647_PARREL.c\
	source/OV5647_tables.c\
...
LOCAL_CFLAGS := -Wall -Wextra -std=c99 -Werror -Wno-unused -Wformat-nonliteral -g -O0 -DDEBUG -pedantic
...
LOCAL_MODULE:= libisp_isi_drv_OV5647
