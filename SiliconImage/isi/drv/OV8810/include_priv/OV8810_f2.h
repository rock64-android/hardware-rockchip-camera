 ...
 *
 */
#ifndef __OV8810_F2_H__
#define __OV8810_F2_H__
...
// crosstalk matrix
const Isi3x3FloatMatrix_t  OV8810_XTalkCoeff_F2 =
{
    {
...
const IsiXTalkFloatOffset_t OV8810_XTalkOffset_F2 =
{
...
// gain matrix
const IsiComponentGain_t OV8810_CompGain_F2 =
{
    .fRed      = 1.73827f,  
    .fGreenR   = 1.00000f,
    .fGreenB   = 1.00000f,
...
const Isi2x1FloatMatrix_t OV8810_GaussMeanValue_F2 =
{
    {
       -0.01853f,  0.10955f 
    }
...
const Isi2x2FloatMatrix_t OV8810_CovarianceMatrix_F2 =
{
    {
...
const IsiSaturationCurve_t OV8810_SaturationCurve_F2 =
{
...
IsiSatCcMatrix_t OV8810_SatCcMatrix_F2[AWB_COLORMATRIX_ARRAY_SIZE_CIE_F2] =
{
    {
        .fSaturation    = 74.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t OV8810_CcMatrixTable_F2 =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE_CIE_F2,
    .pIsiSatCcMatrix    = &OV8810_SatCcMatrix_F2[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t OV8810_SatCcOffset_F2[AWB_COLORMATRIX_ARRAY_SIZE_CIE_F2] =
{
    {
        .fSaturation    = 74.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t OV8810_CcOffsetTable_F2=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE_CIE_F2,
    .pIsiSatCcOffset    = &OV8810_SatCcOffset_F2[0]
};
...
const IsiVignettingCurve_t OV8810_VignettingCurve_F2 =
{
...
IsiVignLscMatrix_t OV8810_VignLscMatrix_CIE_F2_1920x1080[AWB_LSCMATRIX_ARRAY_SIZE_CIE_F2] = 
{
    // array item 0
    {
       .fVignetting    = 100.0f,
...
IsiLscMatrixTable_t OV8810_LscMatrixTable_CIE_F2_1920x1080 = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE_CIE_F2,
    .psIsiVignLscMatrix = &OV8810_VignLscMatrix_CIE_F2_1920x1080[0],
