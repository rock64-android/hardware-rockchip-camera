 ...
 *
 */
#ifndef __OV8810_A_H__
#define __OV8810_A_H__
...
/*****************************************************************************/
// crosstalk matrix
const Isi3x3FloatMatrix_t  OV8810_XTalkCoeff_CIE_A =
{
    {
...
const IsiXTalkFloatOffset_t OV8810_XTalkOffset_CIE_A =
{
...
// gain matrix
const IsiComponentGain_t OV8810_CompGain_CIE_A =
{
    .fRed      = 1.09016f,  
    .fGreenR   = 1.00000f,  
    .fGreenB   = 1.00000f, 
...
const Isi2x1FloatMatrix_t OV8810_GaussMeanValue_CIE_A =
{
    {
       -0.15107f,  0.03529f
    }
...
const Isi2x2FloatMatrix_t OV8810_CovarianceMatrix_CIE_A =
{
    {
...
const IsiGaussFactor_t OV8810_GaussFactor_CIE_A =
 {
    .fGaussFactor = 193.68364f
 };

// thresholds for switching between MAP classification and interpolation
const Isi2x1FloatMatrix_t OV8810_Threshold_CIE_A =
{
    {
        1.00000f,  1.00000f
    }
...
const IsiSaturationCurve_t OV8810_SaturationCurve_CIE_A =
{
...
IsiSatCcMatrix_t OV8810_SatCcMatrix_CIE_A[AWB_COLORMATRIX_ARRAY_SIZE_CIE_A] =
{
    {
        .fSaturation    = 74.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t OV8810_CcMatrixTable_CIE_A =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE_CIE_A,
    .pIsiSatCcMatrix    = &OV8810_SatCcMatrix_CIE_A[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t OV8810_SatCcOffset_CIE_A[AWB_COLORMATRIX_ARRAY_SIZE_CIE_A] =
{
    {
        .fSaturation    = 74.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t OV8810_CcOffsetTable_CIE_A =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE_CIE_A,
    .pIsiSatCcOffset    = &OV8810_SatCcOffset_CIE_A[0]
};
...
const IsiVignettingCurve_t OV8810_VignettingCurve_CIE_A =
{
...
IsiVignLscMatrix_t OV8810_VignLscMatrix_CIE_A_1920x1080[AWB_LSCMATRIX_ARRAY_SIZE_CIE_A] = 
{
    // array item 0
    {
       .fVignetting    = 100.0f,
...
IsiLscMatrixTable_t OV8810_LscMatrixTable_CIE_A_1920x1080 = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE_CIE_A,
    .psIsiVignLscMatrix = &OV8810_VignLscMatrix_CIE_A_1920x1080[0],
