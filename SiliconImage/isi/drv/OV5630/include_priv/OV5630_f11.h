 ...
 *
 */
#ifndef __OV5630_F11_H__
#define __OV5630_F11_H__
...
// crosstalk matrix
const Isi3x3FloatMatrix_t  OV5630_XTalkCoeff_F11 =
{
    {
        2.29942f,  -0.94602f,  -0.35340f, 
       -0.41015f,   1.43303f,  -0.02289f, 
       -0.25425f,  -1.40153f,   2.65578f  
    }
};

// crosstalk offset matrix
const IsiXTalkFloatOffset_t OV5630_XTalkOffset_F11 =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t OV5630_CompGain_F11 =
{
    .fRed      = 1.12529f,
    .fGreenR   = 1.00000f,
    .fGreenB   = 1.00000f,
...
const Isi2x1FloatMatrix_t OV5630_GaussMeanValue_F11 =
{
    {
        -0.03298f,  -0.01163f 
    }
...
const Isi2x2FloatMatrix_t OV5630_CovarianceMatrix_F11 =
{
    {
        754.31351f,   470.96402f, 
    	470.96402f,  2229.81636f 
    }
};

// factor in gaussian mixture model
const IsiGaussFactor_t OV5630_GaussFactor_F11 =
{
    .fGaussFactor = 192.31908f
};

// thresholds for switching between MAP classification and interpolation
const Isi2x1FloatMatrix_t OV5630_Threshold_F11 =
{
    {
...
// saturation curve
float afSaturationSensorGain_F11[AWB_SATURATION_ARRAY_SIZE] =
{
    1.0f, 2.0f, 4.0f, 8.0f
};

float afSaturation_F11[AWB_SATURATION_ARRAY_SIZE] =
{
    100.0f, 95.0f, 90.0f , 70.0f
};

const IsiSaturationCurve_t OV5630_SaturationCurve_F11 =
{
...
IsiSatCcMatrix_t OV5630_SatCcMatrix_F11[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t OV5630_CcMatrixTable_F11 =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &OV5630_SatCcMatrix_F11[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t OV5630_SatCcOffset_F11[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t OV5630_CcOffsetTable_F11=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &OV5630_SatCcOffset_F11[0]
};

// vignetting curve
float afVignettingSensorGain_F11[AWB_VIGNETTING_ARRAY_SIZE] =
{
    1.0f, 2.0f, 4.0f, 8.0f
};

float afVignetting_F11[AWB_VIGNETTING_ARRAY_SIZE] =
{
    60.0f, 80.0f, 90.0f, 100.0f
};

const IsiVignettingCurve_t OV5630_VignettingCurve_F11 =
{
...
IsiVignLscMatrix_t OV5630_VignLscMatrix_F11[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
const IsiLscMatrixTable_t OV5630_LscMatrixTable_F11 = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &OV5630_VignLscMatrix_F11[0]
};
