 ...
 *
 */
#ifndef __OV5630_D50_H__
#define __OV5630_D50_H__
...
// crosstalk matrix
const Isi3x3FloatMatrix_t  OV5630_XTalkCoeff_sunny =
{
    {
...
const IsiXTalkFloatOffset_t OV5630_XTalkOffset_sunny =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t OV5630_CompGain_sunny =
{
    .fRed      = 1.43113f,
    .fGreenR   = 1.00000f,
    .fGreenB   = 1.00000f,
...
const Isi2x1FloatMatrix_t OV5630_GaussMeanValue_sunny =
{
    {
        0.07488f,  -0.01908f 
    }
...
const Isi2x2FloatMatrix_t OV5630_CovarianceMatrix_sunny =
{
    {
        721.80679f,  456.67157f, 
        456.67157f,  2332.16326f
    }
};

// factor in gaussian mixture model
const IsiGaussFactor_t OV5630_GaussFactor_sunny =
{
    .fGaussFactor = 193.28137f
};

// thresholds for switching between MAP classification and interpolation
const Isi2x1FloatMatrix_t OV5630_Threshold_sunny =
{
    {
...
// saturation curve
float afSaturationSensorGain_sunny[AWB_SATURATION_ARRAY_SIZE] =
{
    1.0f, 2.0f, 4.0f, 8.0f
};

float afSaturation_sunny[AWB_SATURATION_ARRAY_SIZE] =
{
    100.0f, 95.0f, 90.0f , 70.0f
};

const IsiSaturationCurve_t OV5630_SaturationCurve_sunny =
{
    .ArraySize      = AWB_SATURATION_ARRAY_SIZE,
    .pSensorGain    = &afSaturationSensorGain_sunny[0],
    .pSaturation    = &afSaturation_sunny[0]
};

// saturation depended color conversion matrices
IsiSatCcMatrix_t OV5630_SatCcMatrix_sunny[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t OV5630_CcMatrixTable_sunny =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &OV5630_SatCcMatrix_sunny[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t OV5630_SatCcOffset_sunny[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t OV5630_CcOffsetTable_sunny=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &OV5630_SatCcOffset_sunny[0]
};

// vignetting curve
float afVignettingSensorGain_sunny[AWB_VIGNETTING_ARRAY_SIZE] =
{
    1.0f, 2.0f, 4.0f, 8.0f
};

float afVignetting_sunny[AWB_VIGNETTING_ARRAY_SIZE] =
{
    60.0f, 80.0f, 90.0f, 100.0f
};

const IsiVignettingCurve_t OV5630_VignettingCurve_sunny =
{
    .ArraySize      = AWB_VIGNETTING_ARRAY_SIZE,
    .pSensorGain    = &afVignettingSensorGain_sunny[0],
    .pVignetting    = &afVignetting_sunny[0]
};

// vignetting dependend lsc matrices
IsiVignLscMatrix_t OV5630_VignLscMatrix_sunny[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
const IsiLscMatrixTable_t OV5630_LscMatrixTable_sunny = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &OV5630_VignLscMatrix_sunny[0]
};
