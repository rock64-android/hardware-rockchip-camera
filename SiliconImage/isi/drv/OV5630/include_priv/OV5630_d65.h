 ...
 *
 */
#ifndef __OV5630_D65_H__
#define __OV5630_D65_H__
...
// crosstalk matrix
const Isi3x3FloatMatrix_t  OV5630_XTalkCoeff_D65 =
{
    {
...
const IsiXTalkFloatOffset_t OV5630_XTalkOffset_D65 =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t OV5630_CompGain_D65 =
{
    .fRed      = 1.49016f,
    .fGreenR   = 1.00000f,
    .fGreenB   = 1.00000f,
...
const Isi2x1FloatMatrix_t OV5630_GaussMeanValue_D65 =
{
    {
        0.09749f,  -0.01594f
    }
...
const Isi2x2FloatMatrix_t OV5630_CovarianceMatrix_D65 =
{
    {
...
// saturation curve
float afSaturationSensorGain_D65[AWB_SATURATION_ARRAY_SIZE] =
{
    1.0f, 2.0f, 4.0f, 8.0f
};

float afSaturation_D65[AWB_SATURATION_ARRAY_SIZE] =
{
    100.0f, 95.0f, 90.0f , 70.0f
};

const IsiSaturationCurve_t OV5630_SaturationCurve_D65 =
{
...
IsiSatCcMatrix_t OV5630_SatCcMatrix_D65[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t OV5630_CcMatrixTable_D65 =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &OV5630_SatCcMatrix_D65[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t OV5630_SatCcOffset_D65[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t OV5630_CcOffsetTable_D65=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &OV5630_SatCcOffset_D65[0]
};

// vignetting curve
float afVignettingSensorGain_D65[AWB_VIGNETTING_ARRAY_SIZE] =
{
    1.0f, 2.0f, 4.0f, 8.0f
};

float afVignetting_D65[AWB_VIGNETTING_ARRAY_SIZE] =
{
    60.0f, 80.0f, 90.0f, 100.0f
};

const IsiVignettingCurve_t OV5630_VignettingCurve_D65 =
{
...
IsiVignLscMatrix_t OV5630_VignLscMatrix_D65[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
const IsiLscMatrixTable_t OV5630_LscMatrixTable_D65 = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &OV5630_VignLscMatrix_D65[0]
};
