 ...
 * - @ref module_name
 *
 * @defgroup ov5630_d80   Illumination Profile D80
 * @{
 *
 */
#ifndef __OV5630_D80_H__
#define __OV5630_D80_H__
...
/*****************************************************************************/
/*!
 * Shade: Outdoor profile (light source: blue sky shaded)
 *  with a measured color temperature of 8200 Kelvin (D82)
 */
/*****************************************************************************/
// crosstalk matrix
const Isi3x3FloatMatrix_t  OV5630_XTalkCoeff_shade =
{
    {
        2.8533053536058794f, -1.5237248277097026f, -0.3295805258961768f,
       -0.3593341683922176f,  2.0370306365506043f, -0.6776964681583867f
       -0.0757009473781296f, -0.7233978770531163f,  1.7990988244312458f
    }
};

// crosstalk offset matrix
const IsiXTalkFloatOffset_t OV5630_XTalkOffset_shade =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t OV5630_CompGain_shade =
{
    .fRed      = 1.6119029098884601f,
    .fGreenR   = 1.0375748712948774f,
    .fGreenB   = 1.0375748712948774f,
    .fBlue     = 1.0000000000000000f
};

// mean value of gaussian mixture model
const Isi2x1FloatMatrix_t OV5630_GaussMeanValue_shade =
{
    {
        0.12818f, -0.00744f
    }
...
const Isi2x2FloatMatrix_t OV5630_CovarianceMatrix_shade =
{
    {
        500.50325f,  -65.57556f, 
        -65.57556f, 2127.80835f 
    }
};

// factor in gaussian mixture model
const IsiGaussFactor_t OV5630_GaussFactor_shade =
{
    .fGaussFactor = 163.91219f
};

// thresholds for switching between MAP classification and interpolation
const Isi2x1FloatMatrix_t OV5630_Threshold_shade =
{
    {
...
// saturation curve
float afSaturationSensorGain_shade[AWB_SATURATION_ARRAY_SIZE] =
{
    1.0f, 2.0f, 4.0f, 8.0f
};

float afSaturation_shade[AWB_SATURATION_ARRAY_SIZE] =
{
    100.0f, 95.0f, 90.0f , 70.0f
};

const IsiSaturationCurve_t OV5630_SaturationCurve_shade =
{
    .ArraySize      = AWB_SATURATION_ARRAY_SIZE,
    .pSensorGain    = &afSaturationSensorGain_shade[0],
    .pSaturation    = &afSaturation_shade[0]
};

// saturation depended color conversion matrices
IsiSatCcMatrix_t OV5630_SatCcMatrix_shade[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t OV5630_CcMatrixTable_shade =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &OV5630_SatCcMatrix_shade[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t OV5630_SatCcOffset_shade[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t OV5630_CcOffsetTable_shade=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &OV5630_SatCcOffset_shade[0]
};

// vignetting curve
float afVignettingSensorGain_shade[AWB_VIGNETTING_ARRAY_SIZE] =
{
    1.0f, 2.0f, 4.0f, 8.0f
};

float afVignetting_shade[AWB_VIGNETTING_ARRAY_SIZE] =
{
    60.0f, 80.0f, 90.0f, 100.0f
};

const IsiVignettingCurve_t OV5630_VignettingCurve_shade =
{
    .ArraySize      = AWB_VIGNETTING_ARRAY_SIZE,
    .pSensorGain    = &afVignettingSensorGain_shade[0],
    .pVignetting    = &afVignetting_shade[0]
};

// vignetting dependend lsc matrices
IsiVignLscMatrix_t OV5630_VignLscMatrix_shade[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
const IsiLscMatrixTable_t OV5630_LscMatrixTable_shade = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &OV5630_VignLscMatrix_shade[0]
};
