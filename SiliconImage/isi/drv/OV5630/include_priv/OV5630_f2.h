 ...
 *
 */
#ifndef __OV5630_F2_H__
#define __OV5630_F2_H__
...
// crosstalk matrix
const Isi3x3FloatMatrix_t  OV5630_XTalkCoeff_F2 =
{
    {
        2.8712989410253393f,  -1.6680610838699454f,  -0.2032378571553941f,
       -0.5522797728455789f,   1.6336733989354111f,  -0.0813936260898322f,
       -0.1343310645120336f,  -1.5504546054583868f,   2.6847856699704202f
    }
};

// crosstalk offset matrix
const IsiXTalkFloatOffset_t OV5630_XTalkOffset_F2 =
{
    .fCtOffsetRed      = 0.0f,
    .fCtOffsetGreen    = 0.0f,
    .fCtOffsetBlue     = 0.0f
...
// gain matrix
const IsiComponentGain_t OV5630_CompGain_F2 =
{
    .fRed      = 1.2626972358458630f,
    .fGreenR   = 1.0000000000000000f,
    .fGreenB   = 1.0000000000000000f,
    .fBlue     = 1.5002410024353223f
};

// mean value of gaussian mixture model
const Isi2x1FloatMatrix_t OV5630_GaussMeanValue_F2 =
{
    {
        -0.01502f,  -0.03556f
    }
...
const Isi2x2FloatMatrix_t OV5630_CovarianceMatrix_F2 =
{
    {
        675.63995f,  264.11087f, 
        264.11087f,  1814.19780f 
    }
};

// factor in gaussian mixture model
const IsiGaussFactor_t OV5630_GaussFactor_F2 =
{
    .fGaussFactor = 171.11858f 
};

// thresholds for switching between MAP classification and interpolation
const Isi2x1FloatMatrix_t OV5630_Threshold_F2 =
{
    {
        0.87000f,  0.93000f  // 1 = disabled
    }
};

// saturation curve
float afSaturationSensorGain_F2[AWB_SATURATION_ARRAY_SIZE] =
{
    1.0f, 2.0f, 4.0f, 8.0f
};

float afSaturation_F2[AWB_SATURATION_ARRAY_SIZE] =
{
    100.0f, 95.0f, 90.0f , 70.0f
};

const IsiSaturationCurve_t OV5630_SaturationCurve_F2 =
{
...
IsiSatCcMatrix_t OV5630_SatCcMatrix_F2[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .XTalkCoeff     =
...
const IsiCcMatrixTable_t OV5630_CcMatrixTable_F2 =
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcMatrix    = &OV5630_SatCcMatrix_F2[0]
};

// saturation depended color conversion offset vectors
IsiSatCcOffset_t OV5630_SatCcOffset_F2[AWB_COLORMATRIX_ARRAY_SIZE] =
{
    {
        .fSaturation    = 100.0f,
        .CcOffset       =
...
const IsiCcOffsetTable_t OV5630_CcOffsetTable_F2=
{
    .ArraySize          = AWB_COLORMATRIX_ARRAY_SIZE,
    .pIsiSatCcOffset    = &OV5630_SatCcOffset_F2[0]
};

// vignetting curve
float afVignettingSensorGain_F2[AWB_VIGNETTING_ARRAY_SIZE] =
{
    1.0f, 2.0f, 4.0f, 8.0f
};

float afVignetting_F2[AWB_VIGNETTING_ARRAY_SIZE] =
{
    60.0f, 80.0f, 90.0f, 100.0f
};

const IsiVignettingCurve_t OV5630_VignettingCurve_F2 =
{
...
IsiVignLscMatrix_t OV5630_VignLscMatrix_F2[AWB_LSCMATRIX_ARRAY_SIZE] = 
{
    // array item 0
    {
        .fVignetting    = 80.0f,
...
const IsiLscMatrixTable_t OV5630_LscMatrixTable_F2 = 
{
    .ArraySize          = AWB_LSCMATRIX_ARRAY_SIZE,
    .psIsiVignLscMatrix = &OV5630_VignLscMatrix_F2[0]
};
